...
var counter = 0;
var text = ["Курсы проводятся на русском и узбекском языках.Наши преподаватели – наша гордость! Стаж работы не менее 7 лет и до 20 лет стажа.", "Все преподаватели проходят повышение квалификации, мы следим за новинками и тенденциями в сфере красоты.Преподавательский состав ежегодно принимает участие в международных Чемпионатах. На сегодняшний день они - многократные призеры и судьи в индустрии красоты. По желанию готовим наших учеников к различным соревнованиям.", "У нас удобный график! Вы сможете самостоятельно выбрать время обучения – днем, утром или вечером!", "Мы всегда с вами на связи и готовы дать совет при работе с клиентами, даже после окончания курса! Преподаватели всегда помогут и подскажут!", "Гарантия результата. Вы выйдете специалистом, готовым к работе!", "Наша цель – помочь вам стать настоящими профессионалами в бьюти индустрии, чтобы вы могли дарить людям счастье и красоту.",];
...
const masters_slider = new Swiper("#masters_slider", {
    speed: 400, slidesPerView: 1, spaceBetween: 20, centeredMode: true, loop: true, navigation: {
